...
export default function CoursesPage() {
  ...
  return (
    <>
      <Navigation />
      <div className="min-h-screen bg-gray-50 dark:bg-gray-50 pt-0 md:pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-gray-900 mb-4 text-balance">คอร์สเรียนทั้งหมด</h1>
            <p className="text-xl text-gray-600 dark:text-gray-600 max-w-3xl mx-auto text-pretty">
          ...
          <motion.div className="mb-4" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}>
            <div className="flex items-center justify-center gap-2 text-gray-800 dark:text-gray-800 mb-3">
              <GraduationCap className="h-5 w-5 text-yellow-600 dark:text-yellow-600" />
          ...
          <motion.div className="mb-8" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.25 }}>
            <div className="flex items-center justify-center gap-2 text-gray-800 dark:text-gray-800 mb-3">
              <BookIcon className="h-5 w-5 text-yellow-600 dark:text-yellow-600" />
          ...
          >
            ...
            {!loading && !error && paginatedCourses.map((course) => (
              <motion.div key={course.id} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                    ...
                    <div className="p-6 bg-white dark:bg-white">
                      {(() => {
                        ...
                        return courseSubjectLabel ? (
                          <div className="mb-2 text-sm font-medium text-yellow-700 dark:text-yellow-700">{courseSubjectLabel}</div>
                        ) : null
                      })()}
                      <h3 className="text-xl font-bold text-gray-900 dark:text-gray-900 mb-2 text-balance line-clamp-2">{course.title}</h3>
                      <p className="text-gray-600 dark:text-gray-700 mb-4 text-pretty line-clamp-2">{course.description}</p>
